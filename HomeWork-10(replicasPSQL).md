...
<i><b>node4Slave</b> убедились что запись появилась на нашем "слэйве"</i>
...
Создаём пустой файл в каталоге данных <b>node4Slave</b>:
 ...
 Очистим таблицы на 1 и 2 ноде:
 
![](pics/dz10/9_trunc_t1.png)

![](pics/dz10/9_trunc_t2.png)

Вставим по одной строке и проверим:

![](pics/dz10/9_final.png)
