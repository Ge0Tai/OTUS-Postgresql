...
Запрос <b>full join</b> вернёт строки с общими ключами в обоих таблицах, а также все строки обоих таблиц, где нет соответствия. Т.е. в нашем случае мы должны получить 2 строки с общими ключами (<b>blue</b> и <b>red</b>) и строки из каждой таблицы, у которых нет соответствия по ключам - 4 строки:
