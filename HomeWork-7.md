...
`select pg_current_wal_insert_lsn();  \\запишем значение LSN перед тестом (0/1D7E2368)`
...
`select pg_current_wal_insert_lsn();  \\запишем значение LSN после завершения теста (0/393F3920)`
